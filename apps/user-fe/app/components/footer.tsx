    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <Image src="/images/latent-logo.png" alt="Latent" width={120} height={40} className="mb-4" />
            <p className="text-gray-400 text-sm mb-4">
              Latent is India's leading entertainment ticketing platform, providing a seamless booking experience for
              movies, events, sports, and more.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">Get the Latent mobile app for seamless booking on the go.</p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Latent Entertainment Pvt. Ltd. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
